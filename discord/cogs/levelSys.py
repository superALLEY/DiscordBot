...
class LevelSystem(commands.Cog):
    def __init__(self, client):
        ...
        with open("\discord\\cogs\\jsonfiles\\users.json", "r") as f:
    ...
    async def save(self):
        ...
        while not self.client.is_closed():
            with open("\discord\\cogs\\jsonfiles\\users.json", "w") as f:
    ...
    async def on_message(self, message):
        ...
        if self.level_up(author_id):
            ...
            level_up_embed = discord.Embed(title="Heheeeee - Level Up!", color=discord.Color.green())
